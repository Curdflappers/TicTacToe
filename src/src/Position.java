...
public class Position implements Comparable<Position>
{
    ...
    /**
     * Return this compared to the other position
     * @param pos the other position to compare to
     * @return positive if this comes after (more bottom or right) pos
     * negative if this comes before (more top or left) pos
     * 0 if this and pos have same coordinates
     */
