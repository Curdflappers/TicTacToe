...
/**
 * This contains information about the board of tic-tac-toe This includes the
 * dimensions of the board, where pieces are, how many pieces in a row to win,
 * and who has won that game based on the board state. A board that has a winner
 * does not accept new pieces.
 *
 * @author mwwie
 *
 */
public class Board {
    ...
    /**
     * The current state of the pieces on this board 0 would be an empty spot 1
     * is a spot taken by player one (X) 2 is a spot taken by player two (O)
     * pieces[0] is the top row of pieces pieces[0][0] is the piece at the
     * top-left of the board
     */
    private int[][] pieces;

    /**
     * The player index of the player that has won the game. -1 if the game is
     * not over 0 if the game was a tie
     */
    private int winner;
    ...
    /** The line on which the winner won */
    ...
    public List<Position> getEmptyPositions() {
        return new ArrayList<>(emptyPositions);
    }
     ...
     *
     * @param p
     * @return the index of the player that occupies this position 0 if empty -1
     * if invalid
     */
    public int get(Position p) {
        return isValid(p) ? pieces[p.row()][p.col()] : -1;
    }
     ...
     * @return whether the new piece has been added: pos is valid, empty, and
     ...
     * <p>
     * Assumes player and pos are valid
     *
    ...
    private List<Line> linesContaining(Position pos) {
        ...
        for (int dir = Position.UP; dir < Position.HALF_CIRCLE;
            ...
            for (int i = 0; i < winLength; i++) {
                ...
                line = new Line(
                        line.getStart().getAdjacentPosition(
                                dir + Position.HALF_CIRCLE),
                        dir,
                        winLength);
            }
        }
     ...
     * <p>
     * 0 if no player won on this line
     * <p>
     * -1 if this line is not a win line
     */
